...
// This will take a movie, search OMDb and return information
var movieThis = function(movie){
    ...
    var queryUrl = "http://www.omdbapi.com/?t=" + movie + "&y=&plot=short&apikey=71b5133a";
    //console.log(queryUrl);
    ...
    request(queryUrl, function(err, response, body){
        ...
        if (!err && response.statusCode === 200) {
            // Need to return: Title, Year, OMDB Rating, Rotten Tomatoes Rating, Country, 
